...
public class Map_Google extends Map_base {

    private String TAG = "Google Plugin";
        ...
        try {
        	plugin.cordova.getActivity().runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    final int resultCode = GooglePlayServicesUtil.isGooglePlayServicesAvailable(plugin.cordova.getActivity());
                    if (resultCode == ConnectionResult.SUCCESS) {
                        ...
                        Dialog dialog = GooglePlayServicesUtil.getErrorDialog(resultCode, plugin.cordova.getActivity(), 1,
