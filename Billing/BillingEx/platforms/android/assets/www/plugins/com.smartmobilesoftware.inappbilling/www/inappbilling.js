...
InAppBilling.prototype.mapProducts = function (success, fail, skus) {
	if (this.options.showLog) {
		log('mapProducts called!');
	}
    ...
    if (!skus.length) {
		...
		return cordova.exec(success, fail, "InAppBillingPlugin", "mapProducts", [skus]);
    }
};
