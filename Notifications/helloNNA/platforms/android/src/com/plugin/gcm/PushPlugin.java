...
public class PushPlugin extends CordovaPlugin {
		...
		if (REGISTER.equals(action)) {
			...
			try {
				...
				if (mSupportedService == SupportedNotificationServices.NokiaPushNotifications) {
		            PushRegistrar.register(getApplicationContext(), gSenderID);
		            result = true;
		        	...
		        	result = false;
					callbackContext.error("No supported services available");
		        }
			...
			if ( gCachedExtras != null) {
			 ...
			 if (mSupportedService == SupportedNotificationServices.NokiaPushNotifications) {
				 PushRegistrar.unregister(getApplicationContext());
		     }else if (mSupportedService == SupportedNotificationServices.GCM) {
    ...
    public void initialize(CordovaInterface cordova, CordovaWebView webView) {
     ...
     // Check the device for supported notifications service
        try {
            PushRegistrar.checkDevice(getApplicationContext());
